    ...
    <div class="container">
        <div class="navigation">
            <ul>
                ...
                <li><a href="#" id="votingScheduleBtn"><span class="icon"><ion-icon name="calendar-outline"></ion-icon></span><span class="title">Schedule Management</span></a></li>
        ...
        <div class="main">
            ...
            <div class="details" id="userManagementSection" style="display:none;">
                <div class="recentOrders">
                    ...
                    <table>
                        <thead><tr><td>ID</td><td>Email</td><td>Student ID</td><td>Password</td><td>Role</td><td>College</td><td>Action</td></tr></thead>
                        <tbody>
                            <?php
        ...
        <script>
            ...
            document.getElementById('collegeFilter').addEventListener('change', function() {
                ...
                // Show/hide rows based on selected college
                rows.forEach(row => {
                    const college = row.getAttribute('data-college');
                    if (!selectedCollege || college === selectedCollege) {
                        row.style.display = '';
                        totalVoters++;
                        if (row.querySelector('.vote-status').classList.contains('voted')) {
                            votedCount++;
                        }
                    } else {
            ...
            // Initialize voters summary on page load
            function initializeVotersSummary() {
                const rows = document.querySelectorAll('#votersTable tbody tr');
